"""
run_subsidy.jl — Region-3 innovation-subsidy counterfactual (grid sweep).

Compares the baseline (no subsidy) against a grid of region-3 innovation
subsidies of size τ = frac · κ̂. Firms innovating in region 3 face private
...
@printf("=== Region-3 innovation subsidy: grid sweep ===\n")
...
plt_grid = plot(SUBSIDY_GRID_FRAC, grid_dWtot;
                ...
                title  = "Welfare effect of the region-3 subsidy",
...
% Region-3 innovation-subsidy grid sweep (sovereign funding accounting).
